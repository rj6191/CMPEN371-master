...
xst -ifn xst.scr
move custom_clock_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\custom_clock_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc custom_clock_exdes.ucf custom_clock_exdes

echo 'Running map'
map -timing -pr b custom_clock_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm custom_clock_exdes -w routed.ncd routed.vhd
cd ..
